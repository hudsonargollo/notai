...
- [x] 1.1 Initialize Shadcn/UI in the repository
...
- [x] 1.5 Create responsive utilities
...
1
- [x] 2.1 Install base Shadcn/UI components
...
- [x] 2.2 Create PageTransition wrapper component
...
- [x] 2.3 Create GlassHeader component
...
- [x] 2.4 Create BottomSheet component
...
- [x] 2.5 Create FloatingActionButton component
...
- [x] 2.6 Implement Global Command Menu
...
- [x] 2.7 Create NeoCore animated mascot component
  - Create `components/layout/NeoCore.tsx`
  - Define NeoState type ('idle' | 'listening' | 'processing' | 'success')
  - Implement 3D cube structure using CSS transforms (6 faces)
  - Add perspective container (800px) for 3D depth
  - Implement animation variants for each state using Framer Motion
  - Add state-based border color transitions (neon for idle/listening, electric for processing)
  - Add internal glowing core that appears during listening state
  - Add ground reflection effect with blur
  - Ensure all animations use spring physics
  - Add circuit detail overlays on cube faces
  - Make component clickable for interactive state changes

## Phase 3: Component Migration

- [x] 3.1 Migrate BudgetModal component
...
- [x] 3.2 Migrate PaywallModal component
...
- [x] 3.3 Migrate SettingsModal component
...
- [x] 3.4 Migrate LoginScreen component
...
- [x] 3.5 Migrate Dashboard component
  - Wrap with PageTransition component
  - Add GlassHeader for navigation
  - Integrate NeoCore mascot as hero element
  - Add state management for NeoCore (useState for NeoState)
  - Add speech bubble component below NeoCore with animation
  - Wire up NeoCore state changes to app events (idle, listening, processing, success)
...
- [x] 3.6 Migrate Scanner component
  - Wrap with PageTransition component
...
- [x] 3.7 Migrate ReviewForm component
...
- [x] 3.8 Migrate Onboarding component
  - Wrap with PageTransition component
...
- [x] 3.9 Migrate AIAssistant component
...
- [x] 3.10 Migrate SplashScreen component
...
- [x] 4.1 Apply consistent iconography
...
- [x] 4.2 Add hover and active state animations
...
- [x] 4.3 Implement loading state patterns
...
- [x] 4.4 Apply glassmorphism effects
...
- [x] 4.5 Refine typography system
...
- [x] 5.1 Test responsive behavior
...
- [x] 5.3 Test animations and performance
...
- [x] 5.5 Test loading states and error handling
...
- [x] 6.1 Document component usage
