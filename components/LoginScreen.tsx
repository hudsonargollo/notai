...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, currentLang }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-slate-800 p-8 rounded-3xl shadow-2xl z-10 flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-10 duration-700">
        ...
        <div className="flex items-center space-x-2 mb-8">
            ...
            <span className="text-xl font-bold text-white tracking-wide">not<span className="text-emerald-400">.</span>AÍ</span>
        </div>
        ...
        <div className="h-16 flex items-center justify-center mb-4 w-full">
            <p className="text-xl font-bold text-white animate-in fade-in slide-in-from-bottom-2 duration-500 key={currentMsgIndex}">
        ...
        <button 
          onClick={onLogin}
          className="w-full bg-white text-slate-900 font-semibold py-3.5 px-4 rounded-xl flex items-center justify-center space-x-3 hover:bg-slate-50 transition-colors active:scale-[0.98] mt-4"
        >
